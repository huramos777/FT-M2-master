...
nombre.innerHTML = "Aplicación creada por: Ivan";
...
function buildToDos(toDos) {
  // Tu código acá:
  return toDos.map((e, index) => buildToDo(e, index));
...
// Tu código acá:
let botom = document.querySelector("#addButton");
botom.addEventListener("click", addToDo); 
